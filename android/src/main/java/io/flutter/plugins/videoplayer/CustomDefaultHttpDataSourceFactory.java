...
/** A {@link Factory} that produces {@link CustomDefaultHttpDataSourceFactory} instances. */
public final class CustomDefaultHttpDataSourceFactory extends BaseFactory {
    ...
    /**
     * Constructs a CustomDefaultHttpDataSourceFactory. Sets {@link
     * CustomDefaultHttpDataSource#DEFAULT_CONNECT_TIMEOUT_MILLIS} as the connection timeout, {@link
     * CustomDefaultHttpDataSource#DEFAULT_READ_TIMEOUT_MILLIS} as the read timeout and disables
    ...
    @Override
    protected CustomDefaultHttpDataSource createDataSourceInternal(
